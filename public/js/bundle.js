...
"use strict";
eval("\n\nvar _Portfolio = __webpack_require__(/*! ./models/Portfolio */ \"./public/js/models/Portfolio.js\");\n\nvar _Portfolio2 = _interopRequireDefault(_Portfolio);\n\nvar _portfolioView = __webpack_require__(/*! ./views/portfolioView */ \"./public/js/views/portfolioView.js\");\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./public/js/views/base.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n$(document).ready(function () {\n\t//NAV SCROLL ANIM\n\t$(window).on(\"scroll\", function () {\n\t\tif ($(document).scrollTop() > 550) {\n\t\t\t$(\"nav\").addClass(\"navBlack\");\n\t\t} else {\n\t\t\t$(\"nav\").removeClass(\"navBlack\");\n\t\t}\n\t});\n\n\t//ABOUT ME SCROLL ANIM\n\t$(\"a[href^='#']\").on(\"click\", function (event) {\n\t\tevent.preventDefault();\n\n\t\tvar target = this.hash;\n\t\tvar $target = $(target);\n\n\t\t//SCROLL AND SHOW HASH\n\t\t$(\"html, body\").animate({\n\t\t\t\"scrollTop\": $target.offset().top\n\t\t}, 700, \"swing\", function () {\n\t\t\twindow.location.hash = target;\n\t\t});\n\t});\n});\n\n//////////////////////////\n//  GLOBAL APP CONTROL  //\n//////////////////////////\n\nvar state = {};\nwindow.state = state;\n\n//////////////////////////\n//     FORM CONTROL     //\n//////////////////////////\n// Listen for form submit\n_base.elements.formDisplay.addEventListener('submit', submitForm);\n\n// Submit form\nvar submitForm = function submitForm() {\n\t// Show alert\n\t_base.elements.formSuccess.style.display = 'inline-block';\n\n\t// Hide alert after 3 seconds\n\tsetTimeout(function () {\n\t\t_base.elements.formSuccess.style.display = 'none';\n\t}, 3000);\n};\n\n//////////////////////////\n//  PORTFOLIO CONTROL  //\n//////////////////////////\nif (!state.type) {\n\t_base.elements.workDisplay.addEventListener('click', function (e) {\n\t\t// 1. Add animation\n\t\tif (!state.type && e.target.matches('.work__choice-opt')) {\n\t\t\tfor (var i = 0; i < 2; i++) {\n\t\t\t\t_base.elements.animationRight[i].classList.add('fadeOutRight');\n\t\t\t\t_base.elements.animationLeft[i].classList.add('fadeOutLeft');\n\t\t\t}\n\t\t\t// Add to state\n\t\t\tstate.type = new _Portfolio2.default();\n\t\t}\n\n\t\t// 2. Clear previous block\n\t\t(0, _base.clearWork)();\n\n\t\t// 3. Display new block\n\t\t(0, _portfolioView.getRender)(e);\n\t});\n} else if (state.type) {\n\t_base.elements.workDisplay.addEventListener('click', function (e) {\n\t\t// 1. Add animation\n\t\tif (e.target.matches('.work__choice-opt')) {\n\t\t\tfor (var i = 0; i < 2; i++) {\n\t\t\t\t_base.elements.animationRight[i].classList.add('fadeOutRight');\n\t\t\t\t_base.elements.animationLeft[i].classList.add('fadeOutLeft');\n\t\t\t}\n\t\t}\n\n\t\t// 2. Clear previous block\n\t\t(0, _base.clearWork)();\n\n\t\t// 3. Display new block\n\t\t(0, _portfolioView.getRender)(e);\n\t});\n}\n\n//# sourceURL=webpack:///./public/js/index.js?");

/***/ }),

/***/ "./public/js/models/Portfolio.js":
/*!***************************************!*\
  !*** ./public/js/models/Portfolio.js ***!
  \***************************************/
/*! no static exports found */
